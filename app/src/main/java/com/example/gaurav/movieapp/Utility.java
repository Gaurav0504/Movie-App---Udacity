    ...
    public static List<MyMovie> formatMovieJson(String api_response){
        ...
        try {
            ...
            for(int i=0; i<results.length(); i++) {
                ...
                String vote_count = each_movie.getString("vote_count");
                ...
                myMovies.add(new MyMovie(id, title, overview, poster_path, backdrop_path, rating, release_date, vote_count, false));
                    MovieRepository movieRepository = new MovieRepository(MainActivity.mContext);
                    movieRepository.insert(id, title, overview, poster_path, backdrop_path, rating, release_date, vote_count, false);
            }

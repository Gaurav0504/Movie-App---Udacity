...
import com.example.gaurav.movieapp.Fragments.MovieDetailsFragment;
import com.example.gaurav.movieapp.Fragments.ReviewFragment;
import com.example.gaurav.movieapp.Fragments.VideoFragment;
...
public class MovieItem extends AppCompatActivity implements Button.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MyMovie movie = (MyMovie) intent.getSerializableExtra("MyMovie");
        assert movie != null;
        movieID = movie.getId();
        ...
        setTitle(getString(R.string.app_name).concat(": Movie Details"));
    ...
    private void backPressedOnReview(){
        if(readReviews.getText().equals(getString(R.string.read_review_button_text))) {
            setTitle(getString(R.string.app_name).concat(": Movie Reviews"));
    ...
    private void backPressedOnTrailers(){
        if(showTrailers.getText().equals(getString(R.string.check_the_trailers))) {
            ...
            setTitle(getString(R.string.app_name).concat(": Movie Trailers"));
    ...
    private void backPressed(View view){
        switch (view.getId()){
            ...
            case R.id.showTrailers:
                ...
                break;
            default:
                Log.d(TAG,"Incorrect item Clicked");

...
import com.example.gaurav.movieapp.Database.MovieDatabase;
import com.example.gaurav.movieapp.Database.MovieRepository;
import com.example.gaurav.movieapp.Database.Movies;
import com.example.gaurav.movieapp.ViewModel.MainActivityViewModel;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, MyMovieAdapter.MyMovieAdapterOnClickHandler{
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(SAVED_API_URL, API_COMPLETE_URL);
    ...
    /*
     loadData will load the UI after checking the network.
     If network is not available, it will show the error along with Refresh Button.
     */
    ...
    /*
        This method loads the enables the UI when
        the Data from the API is available.
     */
    ...
    /*
      This method loads the enables the UI
      when the Data from the API is not available.
   */
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        String API_URL_POPULAR = "http://api.themoviedb.org/3/movie/popular?api_key=";
        String API_URL_TOP_RATED = "https://api.themoviedb.org/3/movie/top_rated?api_key=";
    ...
    /*
 The Onclick will launch the MovieInformation activity.
 @param - MyMovie object for the movie which the user clicked on.
 */
    @Override
